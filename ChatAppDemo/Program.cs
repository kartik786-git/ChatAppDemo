...
using ChatAppDemo.Components;
using ChatAppDemo.Services;
using ChatAppDemo.Services.Ingestion;
using OpenAI;
...
var chatClient = ghModelsClient.AsChatClient("Phi-3-mini-4k-instruct");
